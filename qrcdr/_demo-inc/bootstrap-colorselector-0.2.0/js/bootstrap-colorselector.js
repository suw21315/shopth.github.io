...
(function($) {
  ...
  ColorSelector.prototype = {
    ...
    _init : function() {
      ...
      var selectPrimary = this.$select.find("option:selected").data("primary");
      var selectSecondary = this.$select.find("option:selected").data("secondary");

      var $markupUl = $("<ul>").addClass("dropdown-stoca");
      var $markupDiv = $("<div>").addClass("dropdown").addClass("dropdown-colorselector");
      var $markupSpan = $("<span>").addClass("btn-colorselector").css({"background-color": selectColor, "border-top-color": selectPrimary, "border-bottom-color": selectSecondary});
      ...
      $("option", this.$select).each(function() {
        ...
        var primary = option.data("primary");
        var secondary = option.data("secondary");
        ...
        $markupA.css({"background-color": color, "border-top-color": primary, "border-bottom-color": secondary});
        $markupA.attr("href", "#").attr("data-color", color).attr("data-primary", primary).attr("data-secondary", secondary).attr("data-value", value).attr("title", title);
      ...
      this.$select.on("change", function() {
        ...
        var primary = $(this).find("option[value='" + value + "']").data("primary");
        var secondary = $(this).find("option[value='" + value + "']").data("secondary");
        ...
        $(this).next().find(".btn-colorselector").css({"background-color": color, "border-top-color": primary, "border-bottom-color": secondary});
