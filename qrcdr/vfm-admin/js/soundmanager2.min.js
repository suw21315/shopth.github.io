...
function BasicMP3Player(){var n=this,e=soundManager,t=navigator.userAgent.match(/ipad|iphone/i),s=navigator.userAgent.match(/msie/i);this.excludeClass="button-exclude",this.links=[],this.sounds=[],this.soundsByURL={},this.indexByURL={},this.lastSound=null,this.soundCount=0,this.config={playNext:!1,autoPlay:!1},this.css={sDefault:"sm2_button",sLoading:"sm2_loading",sPlaying:"sm2_playing",sPaused:"sm2_paused"},this.includeClass=this.css.sDefault,this.addEventHandler=void 0!==window.addEventListener?function(n,e,t){return n.addEventListener(e,t,!1)}:function(n,e,t){n.attachEvent("on"+e,t)},this.removeEventHandler=void 0!==window.removeEventListener?function(n,e,t){return n.removeEventListener(e,t,!1)}:function(n,e,t){return n.detachEvent("on"+e,t)},this.classContains=function(n,e){return void 0!==n.className&&n.className.match(new RegExp("(\\s|^)"+e+"(\\s|$)"))},this.addClass=function(e,t){e&&t&&!n.classContains(e,t)&&(e.className=(e.className?e.className+" ":"")+t)},this.removeClass=function(e,t){e&&t&&n.classContains(e,t)&&(e.className=e.className.replace(new RegExp("( "+t+")|("+t+")","g"),""))},this.getSoundByURL=function(e){return void 0!==n.soundsByURL[e]?n.soundsByURL[e]:null},this.isChildOfNode=function(n,e){if(!n||!n.parentNode)return null;e=e.toLowerCase();do{n=n.parentNode}while(n&&n.parentNode&&n.nodeName.toLowerCase()!==e);return n.nodeName.toLowerCase()===e?n:null},this.events={play:function(){},stop:function(){},pause:function(){},resume:function(){},finish:function(){$(".sm2_button").removeClass("sm2_playing")}},this.stopEvent=function(n){return void 0!==n&&void 0!==n.preventDefault?n.preventDefault():void 0!==window.event&&(window.event.returnValue=!1),!1},this.getTheDamnLink=s?function(n){return n&&n.target?n.target:window.event.srcElement}:function(n){return n.target},this.handleClick=function(t){if(void 0!==t.button&&t.button>1)return!0;var s,a,i=n.getTheDamnLink(t);return"a"!==i.nodeName.toLowerCase()&&!(i=n.isChildOfNode(i,"a"))||(!(i.href&&soundManager.canPlayLink(i)&&!n.classContains(i,n.excludeClass))||(!n.classContains(i,n.includeClass)||(e._writeDebug("handleClick()"),s=i.href,(a=n.getSoundByURL(s))?a===n.lastSound?a.togglePause():(a.togglePause(),e._writeDebug("sound different than last sound: "+n.lastSound.id),n.lastSound&&n.stopSound(n.lastSound)):((a=e.createSound({id:"basicMP3Sound"+n.soundCount++,url:s,onfinish:n.events.finish,type:i.type||null}))._data={oLink:i,className:n.css.sPlaying},n.soundsByURL[s]=a,n.sounds.push(a),n.lastSound&&n.stopSound(n.lastSound),a.play()),n.lastSound=a,n.stopEvent(t))))},this.stopSound=function(n){soundManager.stop(n.id),t||soundManager.unload(n.id)},this.init=function(){e._writeDebug("basicMP3Player.init()");var t,s,a=0,i=document.getElementsByTagName("a");for(t=0,s=i.length;t<s;t++)n.classContains(i[t],n.css.sDefault)&&!n.classContains(i[t],n.excludeClass)&&(n.links[a]=i[t],n.indexByURL[i[t].href]=a,a++);a>0&&(n.addEventHandler(document,"click",n.handleClick),n.config.autoPlay&&n.handleClick({target:n.links[0],preventDefault:function(){}})),e._writeDebug("basicMP3Player.init(): Found "+a+" relevant items.")},this.init()}
