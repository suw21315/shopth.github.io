...
function clickFBLike() {
  ...
  document.getElementById("popupDIV").innerHTML = "<iframe src='/fblike.html?r=" + Math.random() + "' frameborder='no' style='height:200px;width:250px;'></iframe><br><button onclick='hideFBLike()' class='w3-btn w3-black'>ปิดx</button>";
}
function hideFBLike() {
...
function login_user(event) {
  ...
  xhttp.open("POST", "http://itshopth.atspace.cc/index.php?module=dologin", true);
