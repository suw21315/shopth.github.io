...
<body>
   ...
   <ul id="tools">
      <li>
         <div class="prompt"><span class="p-q">คุณแน่ใจไหม?</span> <i class="p-y">ใช่</i>| <i class="p-n">ไม่</i></div>
