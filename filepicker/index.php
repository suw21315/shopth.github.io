...
<head>
    ...
    <title>ITFilep - เครื่องมืออัปโหลดไฟล์หลายไฟล์</title>
            ...
            <div id="filepicker">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th class="column-preview">ดูตัวอย่าง</th>
                                <th class="column-name">ชื่อ</th>
                                <th class="column-size">ขนาด</th>
                                <th class="column-date">ดัดแปลง</th>
                                <th>การปฏิบัติ</th>
                            </tr>
                        </thead>
                        <tbody class="files"></tbody>
                        <tfoot><tr><td colspan="5">ไม่พบไฟล์.</td></tr></tfoot>
                    </table>
                </div>
                ...
                <div class="drop-window">
                    <div class="drop-window-content">
                        <h3><i class="fa fa-upload"></i>วางไฟล์เพื่ออัพโหลด</h3>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">ทำการเลือก</h4>
                </div>
                <div class="modal-body">
                    <div class="alert alert-warning crop-loading">กำลังโหลดภาพ...</div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success crop-save" data-loading-text="Saving...">บันทึก</button>
                </div>
            </div>
        </div>
    ...
    <div id="camera-modal" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="close" data-dismiss="modal">&times;</span>
                    <h4 class="modal-title">ถ่ายภาพ</h4>
                </div>
                <div class="modal-body">
                    <div class="camera-preview"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left camera-hide" data-dismiss="modal">ยกเลิก</button>
                    <button type="button" class="btn btn-success camera-capture">ถ่ายภาพ</button>
                </div>
            </div>
        </div>
