...
<body>
    <p><a href="index.php">กลับไปที่ตัวอย่างเต็ม</a></p>

    <div id="filepicker">
        <!-- Button Bar -->
        <div class="button-bar">
            <input type="file" name="files[]" multiple>
            <button type="button" class="camera-show">กล้อง</button>
            <button type="button" class="delete-all">ลบทั้งหมด</button>
        </div>

        <!-- Camera container -->
        <div class="camera-container" style="display: none;">
            <div class="camera-preview"></div>
            <button type="button" class="camera-hide">ยกเลิก</button>
            <button type="button" class="camera-capture">ถ่ายภาพ</button>
        </div>

        <!-- Crop container -->
        <div class="crop-container" style="display: none;">
            <div class="crop-loading">กำลังโหลดภาพ...</div>
            ...
            <p>
                <button type="button" class="crop-hide">ยกเลิก</button>
                <button type="button" class="crop-save">บันทึก</button>
            </p>
        </div>
